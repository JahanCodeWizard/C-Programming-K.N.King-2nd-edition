// 5-upc.c, by Hexenmeister, 22-Nov-2025 Sat
// From: C Programming: A modern Approach, 2nd edition By K. N. King (Ch. 4, Page 71)
// 5-upc.c: the upc check digit calculator. it takes the first 11 digits and then produce the check digit.
...
int main(void){
    ...
    sum_evens= d2 + d4 + d6 + d8 + d10;
    total = (sum_odds * 3) + sum_evens;
