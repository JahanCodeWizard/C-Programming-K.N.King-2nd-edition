// 8-flight-modified.c, by JahanCodeWizard, 25-Jan-2026 Sun
// From: C Programming: A modern Approach, 2nd edition By K. N. King (Ch. 7, Page 158)
/* 8-flight-modified.c: asks user to enter a time in 12 hour format, 
 ...
 * 
 * This version accepts various type of input format for Time, according to Project 8 description.
 */
...
int main(void) {
    ...
    // calculations
    // change the input 12-time into minutes since midnight
    
    // This will make the character into lower-case
    ...
    if (meridiem == 'a') {
        ...
        // invalid meridiem input
        printf("Unexpected Value Detected:\n");
